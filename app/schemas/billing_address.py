# app/schemas/billing_address.py
import datetime
from pydantic import BaseModel, Field
from typing import Optional, List, Dict, Any

class BillingAddressBase(BaseModel):
    """Base pydantic schema representing shared attributes of BillingAddress."""
...
class BillingAddressCreate(BillingAddressBase):
    """Schema used during client creation requests for BillingAddress."""
    pass

class BillingAddressUpdate(BaseModel):
    """Schema representing properties that can be updated in BillingAddress."""
...
class BillingAddressInDBBase(BillingAddressBase):
    id: int
...
class BillingAddress(BillingAddressInDBBase):
    """API response model wrapper for BillingAddress."""
    pass

class BillingAddressDetailedList(BaseModel):
    items: List[BillingAddress]
    total_count: int
    page: int
    size: int
    pages_count: int

class BillingAddressAuditHistory(BaseModel):
    entity_id: int
