...
class KYCVerification(Base):
    """
    SQLAlchemy DB model for KYCVerification.
    ...
    compliance_officer_id = Column(Integer, nullable=True)
    ...
    def __repr__(self) -> str:
        return f'<KYCVerification(id={self.id})>'
