...
class KYCCheckDetail(Base):
    ...
    matches_found = Column(Boolean, default=False, nullable=False)
    ...
    def __repr__(self) -> str:
        return f'<KYCCheckDetail(id={self.id})>'
