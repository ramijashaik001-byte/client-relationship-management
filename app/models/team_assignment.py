...
class TeamAssignment(Base):
    ...
    def __repr__(self) -> str:
        return f'<TeamAssignment(id={self.id})>'
    ...
    def validate_entity_state(self) -> bool:
        ...
        if not self.team_name:
            return False
        if not self.role_in_onboarding:
            return False
        return True
