# app/models/product_subscription.py
import datetime
...
class ProductSubscription(Base):
    ...
    def __repr__(self) -> str:
        return f'<ProductSubscription(id={self.id})>'
