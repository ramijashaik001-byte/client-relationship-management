...
class CreditCheck(Base):
    ...
    credit_limit_recommended = Column(Float, nullable=False)
    ...
    def __repr__(self) -> str:
        return f'<CreditCheck(id={self.id})>'
