# tests/test_beneficial_owner.py
import pytest
...
def test_create_beneficial_owner_service(db_session: Session):
    """Tests direct creation of database records via Service CRUD."""
    obj_in = BeneficialOwnerCreate(**{'client_id': 1, 'first_name': 'Test Mock Data Value', 'last_name': 'Test Mock Data Value', 'date_of_birth': '2026-08-31T12:00:00', 'nationality': 'Test Mock Data Value', 'ownership_percentage': 99.9, 'verification_status': 'Test Mock Data Value'})
    db_obj = BeneficialOwnerService.create(db_session, obj_in=obj_in)
    assert db_obj is not None
    assert db_obj.id is not None
    assert db_obj.first_name == 'Test Mock Data Value'
    assert db_obj.last_name == 'Test Mock Data Value'
    assert db_obj.nationality == 'Test Mock Data Value'
    assert db_obj.ownership_percentage == 99.9
    assert db_obj.verification_status == 'Test Mock Data Value'

def test_read_beneficial_owner_service(db_session: Session):
    """Tests direct read operations via Service CRUD."""
    obj_in = BeneficialOwnerCreate(**{'client_id': 1, 'first_name': 'Test Mock Data Value', 'last_name': 'Test Mock Data Value', 'date_of_birth': '2026-08-31T12:00:00', 'nationality': 'Test Mock Data Value', 'ownership_percentage': 99.9, 'verification_status': 'Test Mock Data Value'})
    db_obj = BeneficialOwnerService.create(db_session, obj_in=BeneficialOwnerCreate(**{'client_id': 1, 'first_name': 'Test Mock Data Value', 'last_name': 'Test Mock Data Value', 'date_of_birth': '2026-08-31T12:00:00', 'nationality': 'Test Mock Data Value', 'ownership_percentage': 99.9, 'verification_status': 'Test Mock Data Value'}))
    fetched = BeneficialOwnerService.get_by_id(db_session, id=db_obj.id)
    assert fetched.id == db_obj.id

def test_update_beneficial_owner_service(db_session: Session):
    """Tests updates applied directly through database ORM layer."""
    db_obj = BeneficialOwnerService.create(db_session, obj_in=BeneficialOwnerCreate(**{'client_id': 1, 'first_name': 'Test Mock Data Value', 'last_name': 'Test Mock Data Value', 'date_of_birth': '2026-08-31T12:00:00', 'nationality': 'Test Mock Data Value', 'ownership_percentage': 99.9, 'verification_status': 'Test Mock Data Value'}))
    obj_update = BeneficialOwnerUpdate(first_name='Modified String Value')
    updated = BeneficialOwnerService.update(db_session, id=db_obj.id, obj_in=obj_update)
    assert updated.first_name == 'Modified String Value'

def test_delete_beneficial_owner_service(db_session: Session):
    """Tests Soft Deletion of database records."""
    db_obj = BeneficialOwnerService.create(db_session, obj_in=BeneficialOwnerCreate(**{'client_id': 1, 'first_name': 'Test Mock Data Value', 'last_name': 'Test Mock Data Value', 'date_of_birth': '2026-08-31T12:00:00', 'nationality': 'Test Mock Data Value', 'ownership_percentage': 99.9, 'verification_status': 'Test Mock Data Value'}))
    deleted = BeneficialOwnerService.delete(db_session, id=db_obj.id)
...
def test_api_read_list(api_client: TestClient):
    ...
    response = api_client.get('/api/v1/beneficial_owner/')
...
def test_api_rule_checkpoint_1(api_client: TestClient):
    ...
    response = api_client.post('/api/v1/beneficial_owner/999999/check-rule-1')
...
def test_api_rule_checkpoint_2(api_client: TestClient):
    ...
    response = api_client.post('/api/v1/beneficial_owner/999999/check-rule-2')
    assert response.status_code == 404
...
def test_api_rule_checkpoint_3(api_client: TestClient):
    ...
    response = api_client.post('/api/v1/beneficial_owner/999999/check-rule-3')
    assert response.status_code == 404
...
def test_api_rule_checkpoint_4(api_client: TestClient):
    ...
    response = api_client.post('/api/v1/beneficial_owner/999999/check-rule-4')
    assert response.status_code == 404
...
def test_api_rule_checkpoint_5(api_client: TestClient):
    ...
    response = api_client.post('/api/v1/beneficial_owner/999999/check-rule-5')
    assert response.status_code == 404
...
def test_api_rule_checkpoint_6(api_client: TestClient):
    ...
    response = api_client.post('/api/v1/beneficial_owner/999999/check-rule-6')
    assert response.status_code == 404
...
def test_api_rule_checkpoint_7(api_client: TestClient):
    ...
    response = api_client.post('/api/v1/beneficial_owner/999999/check-rule-7')
    assert response.status_code == 404
...
def test_api_rule_checkpoint_8(api_client: TestClient):
    ...
    response = api_client.post('/api/v1/beneficial_owner/999999/check-rule-8')
    assert response.status_code == 404
...
def test_api_rule_checkpoint_9(api_client: TestClient):
    ...
    response = api_client.post('/api/v1/beneficial_owner/999999/check-rule-9')
    assert response.status_code == 404
...
def test_api_rule_checkpoint_10(api_client: TestClient):
    ...
    response = api_client.post('/api/v1/beneficial_owner/999999/check-rule-10')
    assert response.status_code == 404
...
def test_api_rule_checkpoint_11(api_client: TestClient):
    ...
    response = api_client.post('/api/v1/beneficial_owner/999999/check-rule-11')
    assert response.status_code == 404
...
def test_api_rule_checkpoint_12(api_client: TestClient):
    ...
    response = api_client.post('/api/v1/beneficial_owner/999999/check-rule-12')
    assert response.status_code == 404
...
def test_api_rule_checkpoint_13(api_client: TestClient):
    ...
    response = api_client.post('/api/v1/beneficial_owner/999999/check-rule-13')
    assert response.status_code == 404
...
def test_api_rule_checkpoint_14(api_client: TestClient):
    ...
    response = api_client.post('/api/v1/beneficial_owner/999999/check-rule-14')
    assert response.status_code == 404
...
def test_api_rule_checkpoint_15(api_client: TestClient):
    ...
    response = api_client.post('/api/v1/beneficial_owner/999999/check-rule-15')
    assert response.status_code == 404
...
def test_api_rule_checkpoint_16(api_client: TestClient):
    ...
    response = api_client.post('/api/v1/beneficial_owner/999999/check-rule-16')
    assert response.status_code == 404
...
def test_api_rule_checkpoint_17(api_client: TestClient):
    ...
    response = api_client.post('/api/v1/beneficial_owner/999999/check-rule-17')
    assert response.status_code == 404
...
def test_api_rule_checkpoint_18(api_client: TestClient):
    ...
    response = api_client.post('/api/v1/beneficial_owner/999999/check-rule-18')
    assert response.status_code == 404
...
def test_api_rule_checkpoint_19(api_client: TestClient):
    ...
    response = api_client.post('/api/v1/beneficial_owner/999999/check-rule-19')
    assert response.status_code == 404
...
def test_api_rule_checkpoint_20(api_client: TestClient):
    ...
    response = api_client.post('/api/v1/beneficial_owner/999999/check-rule-20')
    assert response.status_code == 404
...
def test_api_rule_checkpoint_21(api_client: TestClient):
    ...
    response = api_client.post('/api/v1/beneficial_owner/999999/check-rule-21')
    assert response.status_code == 404
...
def test_api_rule_checkpoint_22(api_client: TestClient):
    ...
    response = api_client.post('/api/v1/beneficial_owner/999999/check-rule-22')
    assert response.status_code == 404
...
def test_api_rule_checkpoint_23(api_client: TestClient):
    ...
    response = api_client.post('/api/v1/beneficial_owner/999999/check-rule-23')
    assert response.status_code == 404
...
def test_api_rule_checkpoint_24(api_client: TestClient):
    ...
    response = api_client.post('/api/v1/beneficial_owner/999999/check-rule-24')
    assert response.status_code == 404
...
def test_api_rule_checkpoint_25(api_client: TestClient):
    ...
    response = api_client.post('/api/v1/beneficial_owner/999999/check-rule-25')
    assert response.status_code == 404
